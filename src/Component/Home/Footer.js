...
export const Footer=()=>{
    ...
    return(
    <Box sx={{background:"rgb(49, 48, 53)"}} className="foter" mt={5}>
        <Container>
            <Box sx={{display:"flex",flexWrap:"wrap",alignItems:"center"}} columnGap={"10px"}>
                <Box sx={{width:{xs:"100%",sm:"20%"},padding:{xs:"10px 0px",md:"20px 0px"}}}>
                    <Box sx={{display:"flex",flexWrap:"wrap",justifyContent:{xs:"center",md:"start"},alignItems:"center"}}>
                        <Typography
                            component="img"
                        ...
                        <Typography
                            component="p" 
                            sx={{color:"whitesmoke",fontSize:"13px"}}>
                                List Your Show
                        </Typography>
                    </Box>
                </Box>

                <Box sx={{display:"flex",justifyContent:{xs:"center"},width:{xs:"100%",sm:"55%"},padding:{xs:"10px 0px",md:"20px 0px" }}}>
                    <Typography
                        component="h1"
                        sx={{color:"whitesmoke",fontSize:"13px"}}>
                ...
                <Box sx={{display:"flex",justifyContent:{xs:"center",md:"end"},width:{xs:"100%",sm:"20%"},padding:{xs:"10px 0px",md:"20px 0px"}}}>
                    <Typography
                        component="a" 
                        sx={{color:"white",p:1,background:"rgb(236, 94, 113)",borderRadius:"6px",fontSize:"13px"}}>
                            Contact Today!
                    </Typography>
                </Box>
            </Box>
        ...
        <Box sx={{backgroundColor:"rgb(64, 64, 67)",borderTop:"1px solid gray",borderBottom:"1px solid gray"}}>
            <Container>
                <Box sx={{display:"flex",flexWrap:"wrap",justifyContent:"center",alignItems:"center"}}>
                    <Box className="hvr" sx={{width:{xs:"100%",sm:"30%"},padding:{xs:"10px 0px",md:"20px 0px"},textAlign:"center",cursor:"pointer"}}>
                        <RiCustomerService2Line style={{fontSize:"40px"}}/>
                        <Typography
                            component="p" 
                            sx={{p:1,borderRadius:"6px",fontSize:"11px"}}>
                                24/7 CUSTOMER CARE
                        </Typography>
                    </Box>

                    <Box className="hvr" sx={{width:{xs:"100%",sm:"30%"},padding:{xs:"10px 0px",md:"20px 0px"},textAlign:"center",cursor:"pointer"}}>
                        <TiTicket style={{fontSize:"40px"}}/>
                        <Typography
                            component="p" 
                            sx={{p:1,borderRadius:"6px",fontSize:"11px"}}>
        ...
        <Container>
            <Box sx={{display:"flex",flexWrap:"wrap",alignItems:"center"}} py={2}>
                <Box sx={{width:"100%"}}>
                    <Typography
                        component="p" 
                        sx={{color:"white",p:1,borderRadius:"6px",fontSize:"12px"}}>
                            HELP
                    </Typography>
                </Box>
                    <Box className="hvr">
                        <Typography
                            component="p"
                            sx={{px:1,cursor:"pointer",fontSize:"12px",borderRight:"1px solid gray"}}>
                                About us
                        </Typography>
                    </Box>
                    ...
                    <Box className="hvr">
                        <Typography
                            component="p" 
                            sx={{px:1,cursor:"pointer",fontSize:"12px"}}>
                                Privacy policy
                        </Typography>
                    </Box>
            </Box>
        ...
        <Box py={5} position={"relative"}>
            ...
            <Box sx={{position:"absolute",top:"23px",backgroundColor:"rgb(49, 48, 53)",left:{xs:"33%",sm:"40%",lg:"45%"}}} px={2}>
                <span>
        ...
        <Container>
            <Box sx={{width:{xs:"60%",sm:"50%",md:"40%",lg:"30%"},display:"flex",flexWrap:"wrap",mx:"auto",justifyContent:"space-between"}} py={5}>
                <Box className="footIcon">
                    <Typography 
                    component="a"
                    sx={{fontSize:"20px",padding:"7px"}}
                    >
                        <BiLogoFacebook/>
                    </Typography>
                </Box>
